...
![Сторінка "Новини"](screenshots/news.png)
...
- Сторили контент для всіх сторінок відповідно де нашої предметної області
...
- Організація файлової структури пролєкту;
- Створення анімацій CSS;

#### Під час роботи було вдосконалено навички та отриманні нові знання:
- Командної взаємодіЇ;
...
- Підвищено рівень володіння HTML, Bootstrap, Phyton, Flask та CSS;
...
- Організувати систему зворотнього зв'язку;
